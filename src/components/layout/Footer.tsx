        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <ul className="mt-4 space-y-2">
              <li><Link to="/#calculator" className="text-base text-gray-600 hover:text-bmi-primary">BMI Calculator</Link></li>
              <li><Link to="/#about" className="text-base text-gray-600 hover:text-bmi-primary">About BMI</Link></li>
              <li><Link to="/#faq" className="text-base text-gray-600 hover:text-bmi-primary">FAQ</Link></li>
            </ul>
          </div>
